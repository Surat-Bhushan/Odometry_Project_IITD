> **Note:** This project was completed as part of my Summer Internship at **IIT Delhi**.
# Project: Autonomous Vehicle Trajectory Estimation using LIDAR Point Clouds
...
|-------------|--------------|
| **[Bhakti Prasad](https://github.com/bhakti123) & Satnoor Saran** | Studied and developed an understanding of the mathematical foundations and theoretical concepts underlying the implemented methods. |
...
- Adaptive outlier rejection (3* median distances)
